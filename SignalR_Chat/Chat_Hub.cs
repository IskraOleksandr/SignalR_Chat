...
{ 
    ...
    {
        IChatRepository rep;
        public Chat_Hub(IChatRepository rep)
        {
            this.rep = rep;
        }

        public async Task Send(string username, string message)// Отправка сообщений
        {
            Message mes = new();
        ...
        public async Task Connect(string userName)// Подключение нового пользователя
        {
